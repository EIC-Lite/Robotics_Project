...
def movej(pose, tool_rotation_deg=0, speed=1.2, acc=0.4, blend=0):
    ...
    # We wrap the move command in pose_trans. 
...
if __name__ == "__main__":
    ...
    # 1. Move to home position (Tool facing down)
    # Using rx=2.22, ry=2.22, rz=0 as you mentioned earlier is equivalent to p[..., 3.14, 0, 0]
